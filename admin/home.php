			...
			<div class="page-header-inner ">
				...
				<div class="page-logo">
					<a href="#">
						...
						<span class="logo-default">PHP</span> </a>
				</div>
				<!-- logo end -->
				<!-- start mobile menu -->
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								...
								<span class="username username-hide-on-mobile"> Welcome, <span class="fw-bold text-uppercase"><?php  if (isset($_SESSION['user'])) : ?>
              ...
              <?php endif ?> </span>
                ...
                <li>
									<a href="create_user.php">
										<i class="icon-user"></i> Create New Profile </a>
								</li>
				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
                    ...
                    <i  style="color: #888;">(<?php echo ucfirst($_SESSION['user']['user_type']); ?>)</i>
									...
									<div class="sidebar-userpic-btn">
										...
										<a class="tooltips" href="home.php?logout='1'" data-placement="top"
